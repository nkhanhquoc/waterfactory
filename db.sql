...
MySQL - 5.5.5-10.1.16-MariaDB : Database - proscom
*********************************************************************
*/
...
insert  into `mode`(`id`,`name`,`image_path`,`updated_at`,`updated_by`,`created_at`,`created_by`) values (1,'Demo','abc','2016-09-20 23:45:22',1,'2016-09-20 23:45:22',1);
...
insert  into `modules`(`id`,`msisdn`,`mode_id`,`country_id`,`privincial_id`,`distric_id`,`customer_code`,`address`,`alarm`,`created_by`,`created_at`,`updated_by`,`updated_at`,`money`) values (1,'000986953037',1,1,1,1,'000001','16/55, ngõ 381 Nguyễn Khang, Cầu Giấy, Hà Nội',NULL,1,'2016-09-21 23:56:57',1,'2016-09-21 23:56:57',NULL);
